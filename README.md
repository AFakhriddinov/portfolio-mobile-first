...
>This project is about building a responsive mobile first portfolio project with html and css.
...
Clone this repository to your desired folder:
  ...
  cd my-folder
  git clone https://github.com/AFakhriddinov/portfolio-mobile-first.git
